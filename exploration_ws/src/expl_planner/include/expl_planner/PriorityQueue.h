...
//{
//public:
//    typedef std::pair<T, PriorityType> PriorityPair;
//    typedef std::vector<PriorityPair> PriorityContainer;
//
//public:
//
//    PriorityQueue()
...
//    }
//
//    void Push(T element, PriorityType priority)
//    {
//        boost::recursive_mutex::scoped_lock locker(mutex_);
//        queue_.push(std::make_pair(element, element));
//    }
//
//    // remove top element 
//    void Pop()
...
//protected:
//
//    std::priority_queue<PriorityPair, PriorityContainer, PriorityQueueComparison<PriorityPair> > queue_;
//
//    boost::recursive_mutex mutex_;
//
//};
