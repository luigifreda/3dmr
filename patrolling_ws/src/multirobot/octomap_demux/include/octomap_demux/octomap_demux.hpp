...
#ifndef OCTOMAP_DEMUX_OCTOMAP_MUX_HPP_
#define OCTOMAP_DEMUX_OCTOMAP_MUX_HPP_
...
class OctomapDeMux {
 ...
 public:
  explicit OctomapDeMux(ros::NodeHandle& n);
  ~OctomapDeMux() {}
 ...
 protected:
  ...
  std::string ref_frame_1;
  std::string ref_frame_2;
