...
#ifndef WAYPOINTS_TOOL_SIM_JACKAL_UGV1_H
#define WAYPOINTS_TOOL_SIM_JACKAL_UGV1_H
...
class WaypointsToolSimJackal1: public WaypointsTool  
{
    Q_OBJECT
public:
    WaypointsToolSimJackal1(
