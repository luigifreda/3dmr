...
#ifndef WAYPOINTS_TOOL_SIM_JACKAL_UGV2_H
#define WAYPOINTS_TOOL_SIM_JACKAL_UGV2_H
...
class WaypointsToolSimJackal2: public WaypointsTool
{
    Q_OBJECT
public:
    WaypointsToolSimJackal2(  
