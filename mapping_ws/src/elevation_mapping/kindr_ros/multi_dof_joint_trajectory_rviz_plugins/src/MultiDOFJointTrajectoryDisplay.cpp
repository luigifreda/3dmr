...
MultiDOFJointTrajectoryDisplay::MultiDOFJointTrajectoryDisplay()
  ...
  property_show_connection_ = new rviz::BoolProperty("Show Connections", show_connection_, "Enable or disable connections rendering.", this,
                                                     SLOT(setShowConnection()));

  property_show_transform_rotation_ =
      new rviz::BoolProperty("Show Transform Rotation", show_transform_rotation_, "Enable or disable rotation transforms rendering.", this,
                             SLOT(setShowTransformRotation()));

  property_show_velocity_linear_ = new rviz::BoolProperty(
      "Show Velocity Linear", show_velocity_linear_, "Enable or disable linear velocities rendering.", this, SLOT(setShowVelocityLinear()));

  property_show_velocity_angular_ =
      new rviz::BoolProperty("Show Velocity Angular", show_velocity_angular_, "Enable or disable angular velocities rendering.", this,
                             SLOT(setShowVelocityAngular()));

  property_show_acceleration_linear_ =
      new rviz::BoolProperty("Show Acceleration Linear", show_acceleration_linear_, "Enable or disable linear accelerations rendering.",
                             this, SLOT(setShowAccelerationLinear()));

  property_show_acceleration_angular_ =
      new rviz::BoolProperty("Show Acceleration Angular", show_acceleration_angular_, "Enable or disable angular accelerations rendering.",
                             this, SLOT(setShowAccelerationAngular()));

  property_size_transform_rotation_ =
      new rviz::FloatProperty("Size Transform Rotation", size_transform_rotation_, "Size of the axes of the rotation transforms.", this,
                              SLOT(setSizeTransformRotation()));
  property_size_transform_rotation_->setMin(0);

  property_diameter_arrows_ =
      new rviz::FloatProperty("Diameter Arrows", diameter_arrows_, "Diameter of the arrows.", this, SLOT(setDiameterArrows()));
  property_diameter_arrows_->setMin(0);

  property_scale_velocity_linear_ = new rviz::FloatProperty("Scale Velocity Linear", scale_velocity_linear_,
                                                            "Scale of the linear velocities.", this, SLOT(setScaleVelocityLinear()));

  property_scale_velocity_angular_ = new rviz::FloatProperty("Scale Velocity Angular", scale_velocity_angular_,
                                                             "Scale of the angular velocities.", this, SLOT(setScaleVelocityAngular()));

  property_scale_acceleration_linear_ =
      new rviz::FloatProperty("Scale Acceleration Linear", scale_acceleration_linear_, "Scale of the linear accelerations.", this,
                              SLOT(setScaleAccelerationLinear()));

  property_scale_acceleration_angular_ =
      new rviz::FloatProperty("Scale Acceleration Angular", scale_acceleration_angular_, "Scale of the angular accelerations.", this,
                              SLOT(setScaleAccelerationAngular()));

  property_color_connection_ = new rviz::ColorProperty("Color Connection", rviz::ogreToQt(color_connection_), "Color of connection lines.",
                                                       this, SLOT(setColorConnection()));

  property_color_velocity_linear_ = new rviz::ColorProperty("Color Velocity Linear", rviz::ogreToQt(color_velocity_linear_),
                                                            "Color of the linear velocities.", this, SLOT(setColorVelocityLinear()));

  property_color_velocity_angular_ = new rviz::ColorProperty("Color Velocity Angular", rviz::ogreToQt(color_velocity_angular_),
                                                             "Color of the angular velocities.", this, SLOT(setColorVelocityAngular()));

  property_color_acceleration_linear_ =
      new rviz::ColorProperty("Color Acceleration Linear", rviz::ogreToQt(color_acceleration_linear_), "Color of the linear accelerations.",
                              this, SLOT(setColorAccelerationLinear()));

  property_color_acceleration_angular_ =
      new rviz::ColorProperty("Color Acceleration Angular", rviz::ogreToQt(color_acceleration_angular_),
                              "Color of the angular accelerations.", this, SLOT(setColorAccelerationAngular()));

  property_alpha_ = new rviz::FloatProperty("Alpha", alpha_, "0 is fully transparent, 1.0 is fully opaque.", this, SLOT(setAlpha()));
  property_alpha_->setMin(0);
  property_alpha_->setMax(1);

  property_font_size_ = new rviz::FloatProperty("Font Size", font_size_, "Size of the font.", this, SLOT(setFontSize()));
  property_font_size_->setMin(0);

  property_show_text_ = new rviz::BoolProperty("Show Caption", show_text_, "Enable or disable text rendering.", this, SLOT(setShowText()));

  property_history_length_ =
      new rviz::IntProperty("History Length", 1, "Number of prior measurements to display.", this, SLOT(setHistoryLength()));
...
void MultiDOFJointTrajectoryDisplay::updateTrajectory() {
  ...
  visuals_points.push_back(boost::shared_ptr<MultiDOFJointTrajectoryPointVisual>(new MultiDOFJointTrajectoryPointVisual(
      context_->getSceneManager(), scene_node_, current_point, show_transform_rotation_, show_velocity_linear_, show_velocity_angular_,
      show_acceleration_linear_, show_acceleration_angular_, size_transform_rotation_, diameter_arrows_, scale_velocity_linear_,
      scale_velocity_angular_, scale_acceleration_linear_, scale_acceleration_angular_, alpha_, color_velocity_linear_,
      color_velocity_angular_, color_acceleration_linear_, color_acceleration_angular_, captions[0], font_size_, show_text_)));
  ...
  for (unsigned int i = 1; i < current_trajectory_->points.size(); i++) {
    ...
    visuals_connections.push_back(
        boost::shared_ptr<MultiDOFJointTrajectoryPointConnectionVisual>(new MultiDOFJointTrajectoryPointConnectionVisual(
            context_->getSceneManager(), scene_node_, last_point, current_point, show_connection_, color_connection_)));
    ...
    visuals_points.push_back(boost::shared_ptr<MultiDOFJointTrajectoryPointVisual>(new MultiDOFJointTrajectoryPointVisual(
        ...
        show_acceleration_linear_, show_acceleration_angular_, size_transform_rotation_, diameter_arrows_, scale_velocity_linear_,
        scale_velocity_angular_, scale_acceleration_linear_, scale_acceleration_angular_, alpha_, color_velocity_linear_,
        color_velocity_angular_, color_acceleration_linear_, color_acceleration_angular_, captions[i], font_size_, show_text_)));
  }
