...
class TsdfServer {
 public:
  ...
  // Publish mesh as pointcloud 
  virtual void publishMeshAsPointcloud();
 ...
 protected:
  ...
  ros::Publisher mesh_pointcloud_pub_;  // surface points + normals (derived from mesh)
